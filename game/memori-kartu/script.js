...
function win() {
  ...
  if (s % 60 < 10) {
      stats.textContent = "Kamu menang dengan: " + stars + " bintang di " + movesCounter + " gerakan, memakan waktu: " + m + ":0" + s % 60;
  } else {
      stats.textContent = "kamu menang dengan: " + stars + " bintang di " + movesCounter + " gerakan, memakan waktu: " + m + ":" + s % 60;
  }
}
