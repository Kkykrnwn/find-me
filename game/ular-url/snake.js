...
function detectBrowserUrlWhitespaceEscaping() {
  ...
  if (location.hash.indexOf(BRAILLE_SPACE) == -1) {
    console.warn('Browser menghilangkan karakter spasi pada URL')
...
function shareScore(scorePoints, grid) {
  var message = '|' + grid + '| Mendapat ' + scorePoints +
    ' memainkan game ular bodoh ini di URL browser!';
