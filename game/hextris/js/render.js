...
function renderBeginningText() {
    ...
    if(/mobile|Mobile|iOS|Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
        mob = true;
        input_text = 'Ketuk sisi kiri dan kanan layar'
        action_text = 'untuk memutar segi enam'
        score_text = 'Satukan 3+ balok untuk mendapatkan poin'
        fontSize = 35
    } else {
        mob = false
        input_text = 'Gunakan tombol panah kiri dan kanan'
        action_text = 'untuk memutar segi enam'
        score_text = 'Satukan 3+ balok untuk mendapatkan poin!'
        fontSize = 27
    }
