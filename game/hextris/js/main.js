...
function showHelp() {
	...
	$("#inst_main_body").html("<div id = 'instructions_head'>CARA BERMAIN</div><p>Tujuan permainan Hextris adalah mencegah balok keluar dari bagian dalam segi enam abu-abu.</p><p>" + (settings.platform != 'mobile' ? 'Tekan tombol panah kanan dan kiri' : 'Ketuk sisi kiri dan kanan layar') + " untuk memutar segi enam." + (settings.platform != 'mobile' ? ' Tekan tombol panah bawah untuk mempercepat jatuhnya balok.': '') + " </p><p>Hancurkan balok dan dapatkan poin dengan menyatukan 3 atau lebih balok dengan warna yang sama.</p><p>Sisa waktu sebelum combo kamu hilang ditunjukkan oleh <span style='color:#f1c40f;'>garis</span> <span style='color:#e74c3c'>berwarna</span> <span style='color:#3498db'>di</span> <span style='color:#2ecc71'>bagian luar</span> segi enam</p> <hr> <p id = 'afterhr'></p> By <a href='http://instagram.com/kky_krnwn331' target='_blank'>Kiky Kurniawan</a>");
	if (gameState == 1) {
		pause();
	}
