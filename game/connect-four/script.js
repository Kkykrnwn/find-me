...
function makeMove(button , buttonNo) {
	...
	if(playerNumber === 1) {
		...
		// Update the player
		playerNumber = 2;
		playerType.textContent = "Player Merah";
		...
		// Update the player
		playerNumber = 1;
		playerType.textContent = "Player Hijau";
