...
function resetGame() {
  ...
  if (hardMode) {
    ...
    <p>Mode sulit, Hindari lubang hitam. Kembali ke mode mudah? Tekan E</p>`;
  } else {
    noteElement.innerHTML = `Klik joystick untuk memulai!
    <p>Pindahkan semua bola ke tengah. Siap untuk mode sulit? Tekan H</p>`;
  }
  ...
  try {
    ...
    if (
      ...
      noteElement.innerHTML = `Congrats, you did it!
        ...
        <p>
          Follow me
          <a href="https://instagram.com/kky_krnwn331" , target="_blank"
            >@kky_krnwn331</a
          >
        </p>`;
      noteElement.style.opacity = 1;
